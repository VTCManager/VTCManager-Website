...
if ($conn->query($sql) === TRUE) {
	...
	$sql = "INSERT INTO money_transfer (sender, receiver, message, date_sent, amount, status)
VALUES ('$username_cookie', '$receiver', '$message', '$date', $amount_conv, 'sent')";
...
mysqli_close($conn); 
header("Location: http://vtc.northwestvideo.de/bank/?idc=tra_sc");
exit;
?> 
